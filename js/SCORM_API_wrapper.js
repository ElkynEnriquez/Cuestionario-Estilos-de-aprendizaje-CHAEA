...
function ObtenerNombre(){
    var cmi="";
    switch(scorm.version){
			case "1.2" : cmi = "cmi.core.student_name"; break;
			case "2004": cmi = "cmi.learner_name"; break;
		}
    var nombreUser = scorm.get(cmi);
...
function ObtenerIdUsuario(){
    var cmi="";
    switch(scorm.version){
			case "1.2" : cmi = "cmi.core.student_id"; break;
			case "2004": cmi = "cmi.learner_id"; break;
		}
    var idUser = scorm.get(cmi);
    return idUser;
}
...
function CompletarCurso(){
    ...
    var callSucceeded=scorm.status("set", "completed")
...
//Se ejucuta al terminar de cargar la pagina
...
function asignarCalificacion(calificacion){
    var cmi="";
    switch(scorm.version){
            case "1.2" : cmi = "cmi.core.score.raw"; break;
            case "2004": cmi = "cmi.score.raw"; break;
        }
    var callSucceeded = scorm.set(cmi,calificacion);
    Mensaje("Calificación asignada? "+ callSucceeded +" = " +calificacion);
}